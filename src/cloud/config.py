...
DIR_ROOT = join(DIR_SRC, pardir)
DIR_DATA = join(DIR_ROOT, "csv")

# Files paths
INITIAL_DATA_FILES = [
    join(DIR_DATA, "Obfuscated-MalMem2022.csv"),
    join(DIR_DATA, "Output1.csv"),
    join(DIR_DATA, "output2.csv"),
    join(DIR_DATA, "output3.csv"),
]
ENV_FILE = join(DIR_ROOT, ".env")
